...
### Voice Input
Tap **microphone icon** → Speak → Text automatically inserted

### Adding Attachments
Open note → Tap **Attach** → Choose Photo/Image/File
...
### Deleting Note
**Swipe** left/right → Confirm **OR** Open note → Tap **Delete Note**
...
You can download application on the [Release](https://github.com/aixandrolab/smart-notebook/releases/tag/v1.0.2) page
...
**Aixandrolab** - [GitHub](https://github.cm/aixandrolab)
